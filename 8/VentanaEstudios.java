...
public class VentanaEstudios extends JFrame implements ActionListener, WindowListener
{
	...
	public void actionPerformed(ActionEvent e){
		...
		if (target == botonAlta){
			listado.setText("DNI: " + dni.getText() + "\n");
			listado.append("Nombre: " + nombre.getText() + "\n");
			listado.append("Población: " + poblacion.getText() + "\n");
			listado.append("Teléfono: " + telefono.getText() + "\n");
			listado.append("Fecha Nacimiento: " + fechaNato.getText() + "\n");
		}
